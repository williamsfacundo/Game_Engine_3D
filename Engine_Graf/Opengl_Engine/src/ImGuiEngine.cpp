...
DllExport void ImGuiEngine::imGuiDrawObject(Entity2d* entity2d, int index)
{
	...
	{
		ImGui::SliderFloat2("Translation", &_traslation.x, 0.0f, Window::GetScreenWidth()); // Al nombre de los sliders si agregas + index se soluciona un problema con multiples entidades
